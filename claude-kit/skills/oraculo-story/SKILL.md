...
name: oraculo:story
description: |
  Focused Socratic definition for executable, pointed work. For clear changes,
  small features, or stories derived from an epic. Adapts to user's role
  (Light/Deep reasoning).
allowed-tools:
  - Read
  - Grep
  - Glob
