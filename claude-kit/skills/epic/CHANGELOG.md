...
- **Phase 00 — Triage problem-solution separation**: Halt block now requires explicitly separating **Observation** (symptom) from **Assumed fix** (proposed solution) before redirecting to `/story`.
